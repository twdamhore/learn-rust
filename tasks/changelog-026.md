# Changelog - Lesson 026: Crates, packages, use, re-exports, prelude pattern
...
- **Recommendations**: None - lesson builds naturally on lesson 025
...
- **Split needed**: No
- **Key issues**: None - requires internet for external crates; good breather after heavy lesson 025
...
- **Needs split**: No
- **Progression**: Good breather after heavy lesson 025. Dependency concepts familiar from Java/Go.
...
- **Needs splitting**: No
- **Pacing context**: Good breather after heavy lesson 025. Dependency management concepts familiar from Java/Go.
...
- **Changes made**: Added path dependency syntax and lesson 027 cross-reference to Exercise 2; added exact Cargo.toml dependency lines (`rand = "0.8"`, `chrono = "0.4"`) to Exercise 3, task file updated
