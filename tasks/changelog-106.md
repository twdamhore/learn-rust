...
- Added explicit Prerequisites section for cross-compilation target setup and architecture inspection tooling.
- Added Windows alternatives when `file` is unavailable (`dumpbin`/`llvm-readobj`/WSL).
