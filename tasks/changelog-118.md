# Changelog - Lesson 118: Project 3 Part C: Benchmarking and Optimization
...
- **Needs split**: No
- **Issues**: Prerequisites should reference 094 AND 095 specifically. Clarify comparison targets for each project option.
- **Changes made**: None
...
- **Pacing**: Good
- **Needs split**: No
- **Issues**: Minor: Prerequisites should reference 094 AND 095 specifically. Should clarify comparison targets for each project option.
...
- **New findings**: Minor -- reference 094/095 specifically as prerequisites. Clarify comparison targets per project option (e.g., Option A vs tokio, Option B vs nom, Option C vs BTreeMap).
...
- **Estimated time**: 70-90min
- **Pacing**: Good/Heavy
- **Issues**: Prerequisite reference to "Lesson 094" should specify split parts
- **Changes made**: Updated prerequisite reference to Lessons 094/095, task file updated
