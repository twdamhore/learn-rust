# Changelog - Lesson 088: Clap - CLI argument parsing, subcommands, derive API
...
- **Estimated time**: 75-90min
- **Pacing**: Good/Heavy
- **Issues**: Exercise 2 requires serde (lesson 086) for JSON persistence but serde not listed as explicit prerequisite
