# Lesson 080: Sealed traits, marker traits, type-level programming
...
> **Callback**: You already used const generics (`<const N: usize>`) in lesson 074's SafeBuffer exercise. This lesson covers them properly — the rules, limitations, and advanced patterns.
