# Changelog - Lesson 022: Enums - basic, with data, Option<T>
...
- **Changes made**: Added if-let syntax inline (`if let Some(value) = option { ... }`) and lesson 023 cross-reference to Exercise 3, task file updated
