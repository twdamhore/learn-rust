# Changelog - Lesson 018: Slices - string slices, array slices, &str vs String
...
- **Issues found**:
  - Exercise 2 returns `Option<&i32>` but `Option` is not introduced until lesson 024
- **Recommendations**:
...
- **Pacing**: Heavy
- **Issues**: Minor — uses Option before lesson 024 but preview note is present
...
- **Why**: Exercise implicitly requires .find() for email domain extraction, taught in 020
