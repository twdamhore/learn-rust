# Changelog - Lesson 051: Lifetime Practice Part A: Diagnosing Lifetime Errors
...
- **Other half (052)**: Lifetime Design Patterns -- over-annotated simplification exercise and the Cache struct exercise. Focus is on when to annotate vs restructure, elision rules, and resolving mutable/immutable borrow conflicts.
...
- **Needs split**: No
- **Issues**: Should reduce puzzle programs from 5 to 3 (drop puzzles 4 and 5). Puzzle 4 is too advanced; puzzle 5 overlaps lesson 055.
...
- **Unresolved from prior reviews**: Reduce puzzles from 5 to 3 -- drop puzzle 4 (too advanced) and puzzle 5 (overlaps lesson 055). Flagged since v2.
- **New findings**: None
