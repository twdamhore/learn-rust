# Lesson 032: Error ecosystem - thiserror, anyhow, best practices
...
## Exercises
- [ ] **Exercise 1 - Rewrite with thiserror**: Take the manual `AppError` from lesson 031 and rewrite it using `thiserror`. Use `#[error("...")]` for Display messages and `#[from]` for automatic From implementations. Verify the behavior is identical
