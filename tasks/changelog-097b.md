# Changelog - Lesson 097b: Capstone Project 2 - Part B: Database and Authentication
...
- **Scope**: Replace in-memory storage with SQLite via sqlx, add JWT authentication with jsonwebtoken crate, add auth middleware with custom extractor. Builds on the working axum API from 097a.
