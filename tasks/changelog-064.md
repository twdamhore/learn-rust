# Changelog - Lesson 064: Tokio basics - tasks, spawn, select!, join!
...
- **Changes made**: Task file updated — added note to Exercise 2 explaining tokio::sync::mpsc as async equivalent of std::sync::mpsc from lesson 059
