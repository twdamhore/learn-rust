# Lesson 105: Browser Integration
...
## Exercises
- [ ] **Exercise 1 -- Load WASM in browser**: Create an HTML page that loads the WASM module built in lesson 104. Use JavaScript to call the GCD and slugify functions, display the results on the page. Serve locally with `python3 -m http.server` or similar.
...
_Split from original lesson 104 which covered WASM basics through browser integration (~2.5-3.5 hr estimated). This part focuses on browser integration with simplified exercises._
