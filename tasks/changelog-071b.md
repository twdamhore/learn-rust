# Changelog - Lesson 071b: Procedural Macros - Part B: Function-Like and Advanced Derive
## Section 15: Macros

### v1 - Created from split (2026-03-03)
- Split from original lesson 071 which was rated OVERLOADED (~2-3 hrs)
- **Reason for split**: Function-like proc macros with custom parsing and the Builder derive macro each require significant time. The Builder derive alone is a mini-project. With the proc macro crate setup already learned in 071a, this lesson can focus on more advanced patterns
...
- **Needs splitting**: No
- **Pacing context**: Heavy but within 2hr limit; depends on 071a foundation
...
- **Needs split**: No
- **Progression**: Depends on 071a foundation; heavy but within 2hr threshold if scaffolding provided
...
- Reviewed. **Time**: 60-80min core. **Pacing**: Medium (up to 120 with STRETCH). **Changes**: Added hint to Exercise 1 showing how quote! generates derive attributes. **Why**: Generating attributes in quote! is a non-obvious pattern not demonstrated in 071a.
