# Changelog - Lesson 037: String in depth - UTF-8, indexing, manipulation
...
- **Issues found**:
  - Overlaps with lesson 019 on string topics (018 = which type to use, 035 = internal structure)
...
- **Split needed**: No
- **Key issues**: None - intentional complement to lesson 019 (018 = which type, 035 = internals); CSV parser may cause borrow checker issues
...
- **Needs split**: No
- **Progression**: Strong complement to lesson 019. CSV parser exercise is right difficulty for this stage.
- **Issues**: None
- **Changes made**: None
...
- **Needs splitting**: No
- **Pacing context**: Complements lesson 019 well (018=when to use which type, 035=UTF-8 internals and manipulation).
- **Unresolved from prior reviews**: None
- **New findings**: None
- **Recommendation**: No changes needed. Intentional and complementary overlap with lesson 019.
...
- **Pacing**: Good
- **Issues**: Some overlap with lesson 019 (String bridge lesson) — intentional deepening. CSV parser in Exercise 4 may trigger borrow checker friction — consider providing lifetime hint
- **Changes made**: Changelog updated only
...
- Reviewed. **Time**: 55-70min. **Pacing**: Medium. **Issues**: None — good complement to lesson 019. **Changes**: Changelog only.
