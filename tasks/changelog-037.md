# Changelog - Lesson 037: Iterators - Iterator trait, adaptors, collect, chaining
...
- **Changes made**: Fixed Exercise 2 starter code to align steps with description (Step 1 skip header, Step 2 filter empty, Step 3 trim, Step 4 enumerate, Step 5 collect). Added closure syntax note referencing Java lambdas and Go function literals, with pointer to lesson 051.
