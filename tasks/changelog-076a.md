# Changelog - Lesson 076a: FFI - Part A: Exposing Rust to C (cdylib, cbindgen)
## Section 16: Unsafe & FFI

### v1 - Created from split (2026-03-03)
- Split from original lesson 076 which was rated OVERLOADED (~2-3 hrs)
...
- Added explicit gcc compilation commands to Exercise 2 (cbindgen header generation) in task-076a.md
