# Changelog - Lesson 045: Trait objects - dyn Trait, vtables, object safety
...
- **Pacing**: Heavy
- **Issues**: Box<dyn Trait> is a forward reference (Box lesson 058); Arc<dyn Trait> is a forward reference (Arc lesson 059)
- **Changes made**: Added Box<T> primer note before exercises section. Removed Arc<dyn Trait> from Objective 2, keeping only Box<dyn Trait> and &dyn Trait, with note that Arc<dyn Trait> is covered in lesson 059.

### v15 - Full curriculum review (2026-03-04)
- Reviewed. **Time**: 70-90min. **Pacing**: Heavy. **Issues**: Suggest adding forward pointer to lesson 058 in Box primer. **Changes**: Changelog only.
