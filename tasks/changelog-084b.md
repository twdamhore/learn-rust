# Changelog - Lesson 084b: Benchmarking Part B: Profiling and Optimization

## Section 18: Testing & Quality

### v1 - Created from task-084 split (2026-03-03)
- Split from original task-084 which was assessed as >2 hr due to too many distinct tools/topics
...
- **Action taken**: Created task-084b.md with 4 objectives and 2 exercises from the original task-084; added platform-specific tooling notes
