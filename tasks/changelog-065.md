# Changelog - Lesson 065: Shared state - Mutex<T>, RwLock, Arc<Mutex<T>>
...
- **Split needed**: No
- **Key issues**:
  - Exercise 3 benchmarking knowledge from lesson 094 (minor forward reference)
...
- **Issues**: Minor forward reference to benchmarking in Exercise 3 (lesson 094), but Instant/elapsed is self-explanatory.
- **Changes made**: None
