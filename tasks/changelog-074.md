# Changelog - Lesson 074: Unsafe functions, unsafe traits, unsafe impl
...
- **Pacing**: Heavy
- **Issues**: Minor — uses const generics (lesson 080) as light forward ref
...
- **Why**: Const generics not formally taught until lesson 080; brief explanation prevents confusion
...
- Added const generics cross-reference note pointing to lesson 080
...
- **Pacing**: Heavy
- **Issues**: Const generics forward ref documented (uses const generics before formal introduction in lesson 080 — inline explanation and cross-reference mitigate)
- **Changes made**: Changelog updated only
