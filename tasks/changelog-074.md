# Changelog - Lesson 074: Pin, Unpin, and Executor Internals
## Section 14: Async Rust

### v1 - Created from split (2026-03-03)
- Split from original lesson 073 which was rated OVERLOADED (~2-3 hrs)
- **Reason for split**: Pin/Unpin is notoriously the most difficult Rust concept. Combined with building a mini executor, this needed its own dedicated lesson. Pin content from lesson 061 also consolidated here where it has proper async context
