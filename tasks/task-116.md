...
- Lesson 092 (proptest -- optional, for property tests)
...
_Split from original lesson 116 which was rated OVERLOADED (~3-5 hr). Architecture guidance is now explicitly provided. Each option is scoped to be achievable in ~2 hours across 116 and 117 combined._
