# Changelog - Lesson 086: Serde - Serialize/Deserialize, JSON, TOML, custom
...
- **Unresolved from prior reviews**: HIGH PRIORITY: Exercise 4 (custom Deserialize with Visitor pattern) MUST be [STRETCH/OPTIONAL]. Flagged 6 consecutive times since v4. Highest-impact unfixed issue in lessons 081-090. Without this fix, lesson exceeds 2 hours.
- **New findings**: None
