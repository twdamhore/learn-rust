# Lesson 019: Strings Part A - String vs &str, When to Use Which

## Section 4: Strings & Slices (split from lesson 019)

## Status: pending

## Added
- Split from task-019 (v13 pacing review, 2026-03-04)
...
- Continues in 020 (UTF-8 and string manipulation)
