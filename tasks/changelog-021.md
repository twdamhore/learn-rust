# Changelog - Lesson 021: The derive attribute - Debug, Clone, PartialEq, Eq, Hash
...
- **Estimated time**: 50-60min
- **Pacing**: Light-Medium
- **Changes made**: Added HashMap usage note to Exercise 4 explaining minimal HashMap usage needed and pointing to lesson 036
- **Why**: Minor forward reference to HashMap (lesson 036) lacked usage context
