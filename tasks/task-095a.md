# Lesson 095a: Capstone Project 1 - Part A: CLI Tool Setup and Core Processing
...
## Prerequisites
- Lesson 086 (serde - for TOML config loading)
- Lesson 088 (clap - for CLI argument parsing)
- Lesson 032 (thiserror/anyhow - for error handling)
...
_Split from original lesson 095 which was rated OVERLOADED (~2.5-3.5 hr). Simplified from original: removed expression-evaluator filter condition ("age > 30"), csv crate usage is optional (can work with plain text files)._
