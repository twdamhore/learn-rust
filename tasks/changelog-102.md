# Changelog - Lesson 102: Database Part B - CRUD, Testing, and Repository Pattern

## Section 19: Ecosystem & Tooling

### v1 - Created from split (2026-03-04)
- Split from task-101 during v13 full curriculum pacing review
- **Why split**: Original lesson 101 rated ~2.5 hours with setup time. CRUD + integration tests + repository pattern too much for one session.
...
- **Exercises**: Complete CRUD module (extends 101 queries), integration tests with in-memory DB, repository pattern [STRETCH] (original Ex 4 with async-trait note retained)
