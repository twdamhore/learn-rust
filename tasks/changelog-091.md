# Changelog - Lesson 091: Integration tests, test fixtures, conditional compilation
...
- **Issues found**:
  - Exercise 3 references serde feature-gating -- serde not taught until lesson 097 (light forward reference)
- **Recommendations**:
...
- **Changes noted**: Exercise 3 uses serde (feature-gating) before serde is taught (lesson 097). A simpler feature example would be more appropriate.
...
- **Split needed**: No
- **Key issues**:
  - Exercise 3 uses serde feature-gating but serde not taught until lesson 097 (forward reference)
...
- **Needs split**: No
- **Issues**: Exercise 3 uses serde feature-gating but serde not taught until lesson 097. Replace with simpler feature example (flagged since v4 across 4 review rounds, STILL unresolved).
...
- **Unresolved from prior reviews**: Exercise 3 uses serde feature-gating but serde not taught until lesson 097 — replace with simpler feature example. Also overlaps with task 093 Exercise 3 (both feature-gate with serde).
- **New findings**: None
