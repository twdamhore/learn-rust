# Changelog - Lesson 093: Cross-compilation, conditional compilation, cfg attributes
...
- **Issues found**:
  - Significant overlap with lesson 082 on #[cfg()] topics (082 intro, 093 broader coverage)
...
- **Changes noted**: cfg and feature concepts well-scoped. Significant overlap with lesson 082 (both cover #[cfg] and feature gating). Exercise 3 nearly identical to task 082 Exercise 3 (both feature-gate with serde). Exercise format inconsistency.
- **Why**: Overlap and duplication with lesson 082.
...
- **Split needed**: No
- **Key issues**:
  - Significant overlap with lesson 082 on #[cfg()] topics
...
- **Pacing**: Good
- **Issues**: Ex 3 (feature-gated serde) overlaps lesson 082 Ex 3
- **Recommendations**: Differentiate from lesson 082 more explicitly
- **Changes made**: Changelog updated only

### v13-fix - Applied pending fixes (2026-03-04)
- Added differentiation note to Exercise 3 explaining how it differs from lesson 082 Exercise 3
...
- Reviewed. **Time**: 70-85min. **Pacing**: Good. **Issues**: None — differentiation from lesson 082 verified. **Changes**: Changelog only.
